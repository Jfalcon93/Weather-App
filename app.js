    ...
    if(navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(position => {
            ...
            .then(data => {
                ...
                dayOne.children[0].textContent = "Monday";
                ...
                dayTwo.children[0].textContent = "Tuesday";
                ...
                dayThree.children[0].textContent = "Tuesday";
                ...
                dayFour.children[0].textContent = "Tuesday";
                ...
                dayFive.children[0].textContent = "Tuesday";
